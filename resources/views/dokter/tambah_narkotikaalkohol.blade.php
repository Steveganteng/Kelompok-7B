...
<head>
    ...
    <title>Tambah narkotika alkohol</title>
    ...
    <div id="wrapper">
        ...
        <div class="container-fluid mt-4">
            ...
            <div class="card shadow p-4">
                <form id="narkotikaalkohol-form" action="{{ route('narkotikaalkohol.store') }}" method="POST">
                    @csrf
...
<div class="form-step" id="step3">
    ...
    <script>
        ...
        document.getElementById('narkotikaalkohol-form').addEventListener('submit', () => {
            document.getElementById('tindakan_data').value = JSON.stringify(alatKesehatan);
            document.getElementById('resep_data').value = JSON.stringify(resepList);
        });
