...
<head>
    ...
    <title>Tambah pemeriksaan kesehatan</title>
    ...
    <div id="wrapper">
        ...
        <div class="container-fluid mt-4">
            ...
            <div class="card shadow p-4">
                <form id="pemeriksaankesehatan-form" action="{{ route('pemeriksaankesehatan.store') }}" method="POST">
                    @csrf
...
<div class="form-step" id="step3">
    ...
    <script>
        ...
        document.getElementById('pemeriksaankesehatan-form').addEventListener('submit', () => {
            document.getElementById('tindakan_data').value = JSON.stringify(alatKesehatan);
            document.getElementById('resep_data').value = JSON.stringify(resepList);
        });
