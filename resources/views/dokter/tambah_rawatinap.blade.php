...
<body id="page-top">
                ...
                <form id="rawatinap-form" action="{{ route('rawatinap.store') }}" method="POST">
                    ...
                    <div id="step2" style="display:none">
                        <div class="form-group">
                            ...
                            <input id="mulai_diwawati" name="mulai_diwawati" type="datetime-local" class="form-control" required />
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <input id="tinggi_badan" name="tinggi_badan" type="number" class="form-control" required />
                            </div>
                            <div class="form-group col-md-4">
                                <label>Berat (kg)</label>
                                <input id="berat_badan" name="berat_badan" type="number" class="form-control" required />
                            </div>
                            <div class="form-group col-md-4">
                                <label>Suhu (°C)</label>
                                <input id="suhu_tubuh" name="suhu_tubuh" type="number" step="0.1" class="form-control" required />
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-4">
    ...
    <script>
        ...
        document.getElementById('rawatinap-form').addEventListener('submit', () => {
            document.getElementById('tindakan_data').value = JSON.stringify(alatKesehatan);
            document.getElementById('resep_data').value = JSON.stringify(resepList);
        });
