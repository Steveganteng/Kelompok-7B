                    ...
                    <div class="container py-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-4">
                                <div class="card shadow h-100 py-2">
                                    <div class="card-body text-center">
                                        <i class="fas fa-hospital-user fa-2x text-primary mb-3"></i>
                                        <h5 class="card-title">Rawat Jalan</h5>
                                        <a href="#" class="btn btn-primary btn-sm mt-2">Buka</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 mb-4">
                                <div class="card shadow h-100 py-2">
                                    <div class="card-body text-center">
                                        <i class="fas fa-vials fa-2x text-primary mb-3"></i>
                                        <h5 class="card-title">Pemeriksaan Narkotika & Alkohol</h5>
                                        <a href="#" class="btn btn-primary btn-sm mt-2">Buka</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 mb-4">
                                <div class="card shadow h-100 py-2">
                                    <div class="card-body text-center">
                                        <i class="fas fa-briefcase-medical fa-2x text-primary mb-3"></i>
                            ...
                            <div class="col-md-4 mb-4">
                                <div class="card shadow h-100 py-2">
                                    <div class="card-body text-center">
                                        ...
                                        <h5 class="card-title">Keterangan Berobat</h5>
                                        <a href="#" class="btn btn-primary btn-sm mt-2">Buka</a>
                                    </div>
                                </div>
                            </div>
