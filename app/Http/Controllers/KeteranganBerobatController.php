...
{
    /**
     * Display a list of keterangan berobat (patients and their prescriptions, etc. - can be customized)
     */
   public function index()
{
    // Fetch only patients with 'keterangan berobat' pemeriksaan, and their associated reseps
    $keteranganberobat = Pasien::whereHas('pemeriksaan', function ($query) {
        $query->where('jenis_pemeriksaan', 'keterangan berobat');
    })
    ...
    /**
     * Show the form for creating a new keterangan berobat
     */
    ...
    /**
     * Store a newly created keterangan berobat in the database
     */
  public function store(Request $request)
{
    ...
    DB::transaction(function () use ($validatedData) {
        // Tentukan jenis pemeriksaan dengan nilai default 'keterangan berobat'
        $jenisPemeriksaan = 'keterangan berobat';  // Set default to 'keterangan berobat'
        ...
        $pasien = Pasien::create([
            ...
            'jenis_pemeriksaan' => $jenisPemeriksaan,  // Set jenis_pemeriksaan to 'keterangan berobat' by default
        ]);
