...
{
    /**
     * Display a list of kecelakaan kerja (patients and their prescriptions, etc. - can be customized)
     */
   public function index()
{
    // Fetch only patients with 'kecelakaan kerja' pemeriksaan, and their associated reseps
    $kecelakaankerja = Pasien::whereHas('pemeriksaan', function ($query) {
        $query->where('jenis_pemeriksaan', 'kecelakaan kerja');
    })
    ->with('reseps')  // Eager load the reseps relation
    ->get();

    // Pass the filtered data to the view
    return view('dokter.kecelakaankerja', compact('kecelakaankerja'));
}


    /**
     * Show the form for creating a new kecelakaan kerja
     */
    public function create()
    {
        ...
        return view('dokter.tambah_kecelakaankerja', compact('obats', 'alatKesehatan'));
    }

    /**
     * Store a newly created kecelakaan kerja in the database
     */
  public function store(Request $request)
{
    ...
    DB::transaction(function () use ($validatedData) {
        // Tentukan jenis pemeriksaan dengan nilai default 'kecelakaan kerja'
        $jenisPemeriksaan = 'kecelakaan kerja';  // Set default to 'kecelakaan kerja'
        ...
        $pasien = Pasien::create([
            ...
            'jenis_pemeriksaan' => $jenisPemeriksaan,  // Set jenis_pemeriksaan to 'kecelakaan kerja' by default
        ]);
    ...
    return redirect()->route('kecelakaankerja.index')->with('success', 'kecelakaan kerja berhasil disimpan.');
}
