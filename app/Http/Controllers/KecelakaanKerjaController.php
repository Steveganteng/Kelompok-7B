...
{
    /**
     * Tampilkan daftar Kecelakaan Kerja
     */
    public function index()
    {
        $kecelakaankerja = Pasien::with('pemeriksaan')->get();
        return view('dokter.kecelakaankerja', compact('kecelakaankerja'));
    }

    /**
     * Tampilkan form tambah Kecelakaan Kerja
     */
    ...
    /**
     * Proses penyimpanan data Kecelakaan Kerja
     */
