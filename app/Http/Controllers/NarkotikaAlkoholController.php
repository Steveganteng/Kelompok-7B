...
{
    /**
     * Tampilkan daftar narkotika alkohol
     */
    public function index()
    {
        $narkotikaalkohol = Pasien::with('pemeriksaan')->get();
        return view('dokter.narkotikaalkohol', compact('narkotikaalkohol'));
    }

    /**
     * Tampilkan form tambah narkotika alkohol
     */
    ...
    /**
     * Proses penyimpanan data narkotika alkohol
     */
