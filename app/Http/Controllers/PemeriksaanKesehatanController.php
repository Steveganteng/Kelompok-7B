...
{
    /**
     * Tampilkan daftar pemeriksaan kesehatan
     */
    public function index()
    {
        $pemeriksaankesehatan = Pasien::with('pemeriksaan')->get();
        return view('dokter.pemeriksaankesehatan', compact('pemeriksaankesehatan'));
    }

    /**
     * Tampilkan form tambah pemeriksaan kesehatan
     */
    ...
    /**
     * Proses penyimpanan data pemeriksaan kesehatan
     */
                ...
                foreach ($tindakanList as $t) {
                    if (!empty($t['nama_tindakan']) && !empty($t['alat_id']) && !empty($t['jumlah'])) {
                        ...
                        Resep::create([
                            ...
                            'jenis_rawat' => 'pemeriksaan kesehatan',
                            'user_id' => $userId,
                            'pasien_id' => $pasien->id_pasien,
                            'obat_id' => null,
                            'jumlah' => $t['jumlah'],
