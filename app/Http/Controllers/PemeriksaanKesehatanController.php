...
{
    /**
     * Display a list of pemeriksaan kesehatan (patients and their prescriptions, etc. - can be customized)
     */
   public function index()
{
    // Fetch only patients with 'pemeriksaan kesehatan' pemeriksaan, and their associated reseps
    $pemeriksaankesehatan = Pasien::whereHas('pemeriksaan', function ($query) {
        $query->where('jenis_pemeriksaan', 'pemeriksaan kesehatan');
    })
    ->with('reseps')  // Eager load the reseps relation
    ->get();

    // Pass the filtered data to the view
    return view('dokter.pemeriksaankesehatan', compact('pemeriksaankesehatan'));
}


    /**
     * Show the form for creating a new pemeriksaan kesehatan
     */
    public function create()
    {
        ...
        return view('dokter.tambah_pemeriksaankesehatan', compact('obats', 'alatKesehatan'));
    }

    /**
     * Store a newly created pemeriksaan kesehatan in the database
     */
  public function store(Request $request)
{
    ...
    DB::transaction(function () use ($validatedData) {
        // Tentukan jenis pemeriksaan dengan nilai default 'pemeriksaan kesehatan'
        $jenisPemeriksaan = 'pemeriksaan kesehatan';  // Set default to 'pemeriksaan kesehatan'
        ...
        $pasien = Pasien::create([
            ...
            'jenis_pemeriksaan' => $jenisPemeriksaan,  // Set jenis_pemeriksaan to 'pemeriksaan kesehatan' by default
        ]);
    ...
    return redirect()->route('pemeriksaankesehatan.index')->with('success', 'pemeriksaan kesehatan berhasil disimpan.');
}
